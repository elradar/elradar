...
_Agradecemos a [Angie Scetta](https://www.linkedin.com/in/mar%C3%ADa-de-los-%C3%A1ngeles-scetta-b7b82a80/), arquitecta (UBA) y maestranda en Economía Urbana (UTDT), que nos muestra cómo usar `OSRM`, el paquete de R para estimar trayectos, tiempos y distancias de viaje a través de la grilla de calles de cualquier parte del mundo. 

Angie se especializa en análisis de datos urbanos. Trabaja en el Gobierno de la Ciudad de Buenos Aires analizando el impacto en la ciudad de proyectos de diversas áras de gobierno, y como profesora asistente en Ciencia de Datos para Ciudades en UTDT_
